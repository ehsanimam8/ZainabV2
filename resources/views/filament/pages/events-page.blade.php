<x-filament-panels::page>
	<div id="crm-events-list-panel">
		...
		<div class="stats-grid grid grid-cols-4 gap-4 mb-6">
			<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200"><span class="stat-label text-sm text-gray-500 uppercase tracking-widest font-bold block mb-2">Upcoming Events</span><div class="stat-value text-3xl font-bold">4</div></div>
			<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200"><span class="stat-label text-sm text-gray-500 uppercase tracking-widest font-bold block mb-2">Total Registrants</span><div class="stat-value text-3xl font-bold">312</div></div>
			<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200"><span class="stat-label text-sm text-gray-500 uppercase tracking-widest font-bold block mb-2">Paid Revenue</span><div class="stat-value text-3xl font-bold text-teal-600">$2,480</div></div>
			<div class="card p-6 bg-white rounded-xl shadow-sm border border-gray-200"><span class="stat-label text-sm text-gray-500 uppercase tracking-widest font-bold block mb-2">Pending Payment</span><div class="stat-value text-3xl font-bold text-rose-600">7</div></div>
		</div>
